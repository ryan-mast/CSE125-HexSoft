...
void InitAllVertexDeclarations()
{
	...
	(gd3dDevice->CreateVertexDeclaration(VertexColElements, &VertexCol::Decl));
	...
	(gd3dDevice->CreateVertexDeclaration(VertexPNElements, &VertexPN::Decl));
	...
	(gd3dDevice->CreateVertexDeclaration(VertexPNTElements, &VertexPNT::Decl));
	...
	(gd3dDevice->CreateVertexDeclaration(GrassVertexElements, &GrassVertex::Decl));
}
